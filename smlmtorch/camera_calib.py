...
class CameraCalibration:
    ...
    def get_roi_calib(info_yaml_fn, camera_calib_fn, roi_index=0, plot=False):
        ...
        with open(info_yaml_fn, "r") as s:
            ...
            info = struct.from_dict(info)
            # rois have format: x,y,w,h
            #print(info)

        calib = CameraCalibration(camera_calib_fn)
...
if __name__ == '__main__':
    ...
    calib = CameraCalibration.get_roi_calib(info_fn, calib_fn, plot=True)
